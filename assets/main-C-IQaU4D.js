...
`)+`
`+N);const C=R+m+u,B=R+N+c,z=ap(o,o.VERTEX_SHADER,C),I=ap(o,o.FRAGMENT_SHADER,B);o.attachShader(g,z),o.attachShader(g,I),t.index0AttributeName!==void 0?o.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(g,0,"position"),o.linkProgram(g);function j(Me){if(r.debug.checkShaderErrors){const _e=o.getProgramInfoLog(g).trim(),G=o.getShaderInfoLog(z).trim(),se=o.getShaderInfoLog(I).trim();let ne=!0,ue=!0;if(o.getProgramParameter(g,o.LINK_STATUS)===!1)if(ne=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(o,g,z,I);else{const te=lp(o,z,"vertex"),ce=lp(o,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(g,o.VALIDATE_STATUS)+`
...
`)+he+`return __p
            ...
            void main() {
                ...
                float t = clamp((distance - 50.0) / 450.0, 0.0, 1.0); // Normalized distance (0-1)
                float easedT = 1.0 - (1.0 - t) * (1.0 - t) * (1.0 - t); // Cubic ease-out
                
                // Blend between close-up and far-away behaviors
                float closeUpFactor = 1.5;
                float farAwayFactor = 0.8;
